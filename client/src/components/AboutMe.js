    ...
    return (
        <div>
            ...
            <div className='image-txt-container'>
                <div className='text'>Hello! I am James! I was born and raised in Arlington, Texas and moved to the suburbs of Chicago for a job promotion in 2014. I figured why not move from extreme
                ...
                <div className='image-caption-container'>
                    <img src={notACoat} className="image" />
            ...
            <div className='image-txt-container'>
                ...
                <div className='image-caption-container'>
                    <img src={EscapeRoom} className="image" />
                    <div className='caption'>
                        Escaped!
                    </div>
                </div>
            ...
            <div className='image-txt-container'>
                <div className='text'>I live with my girlfriend of six years now with our Cockapoo dog named Simba. My long term goals would be to settle down with a career in the software deveolpment field,
            buy a home and start a family. This website you are reading now is a step forward in the journey to achieve those goals.
                </div>

                <div className='image-caption-container'>
                    <img src={Christmas} className="image" />
                    <div className='caption'>
                        The mop is the dog
                    </div>
                </div>
